...
public class EmployeeController {
	...
	// public ResponseEntity<?> viewEmployeeOffers(@RequestHeader(name =
	// "Authorization", required = true) String token,
	// @PathVariable("id") int employeeId) throws InvalidUserException,
	// MicroserviceException {
	// log.info("Inside view employee offers");
	// return new ResponseEntity<>(employeeService.viewEmpOffers(token, employeeId),
	// HttpStatus.OK);
	// }
